...
uint32_t GUI_IO_CONTROL_TEST_CLASS::get_expected_recv_length_test()
{
...
uint32_t GUI_IO_CONTROL_TEST_CLASS::get_current_recv_length_test()
{
    return current_recv_length;
}

void GUI_IO_CONTROL_TEST_CLASS::on_ResetGUI_Button_clicked_test()
{
